...
export default class AuthService {
  ...
  static async registration(firstName, lastName, email, companyName, password, role) {
    return $api.post('/registration', {firstName, lastName, email, companyName, password, role})
  }
